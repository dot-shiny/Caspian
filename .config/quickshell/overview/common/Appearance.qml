...
Singleton {
    ...
    property QtObject defaultColors: QtObject {
        ...
        property color m3primary: "#fa0567"                  // Твой розовый неон для активных рамок
        property color m3onPrimary: "#1a1a1a"
        property color m3primaryContainer: "#73022f"         // Твой темно-бордовый для контейнеров
        property color m3onPrimaryContainer: "#ffffff"
        property color m3secondary: "#73022f"
        property color m3onSecondary: "#ffffff"
        property color m3secondaryContainer: "#1a1a1a"
        property color m3onSecondaryContainer: "#ffffff"
        property color m3background: "#1a1a1a"               // Твой глубокий темный фон оверлея
        property color m3onBackground: "#ffffff"
        property color m3surface: "#1a1a1a"                  // Фон плиток/карточек
        property color m3surfaceContainerLow: "#151515"
        property color m3surfaceContainer: "#1a1a1a"
        property color m3surfaceContainerHigh: "#222222"
        property color m3surfaceContainerHighest: "#2d2d2d"
        property color m3onSurface: "#ffffff"
        property color m3surfaceVariant: "#1a1a1a"
        property color m3onSurfaceVariant: "#ffffff"
        property color m3inverseSurface: "#ffffff"
        property color m3inverseOnSurface: "#1a1a1a"
        property color m3outline: "#73022f"                  // Цвет неактивных рамок окон
        property color m3outlineVariant: "#444444"
